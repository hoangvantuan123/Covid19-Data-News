...
/*     const [countries, setCountries] = React.useState([]); */
    ...
    /*   const exportDataJson = useEffect(() => {
          async function loadCountry() {
              ...
              try {
                  ...
                  console.log('[TestGetAllCountrytestjson]', countries);
    ...
    var url = 'https://raw.githubusercontent.com/owid/covid-19-data/master/public/data/owid-covid-data.csv';
                        ...
                        <BootstrapDialogTitle id="customized-dialog-title" onClose={handleClose}>
                            ...
                            <Box sx={{ display: "flex", gap: 1 }} className="phone:flex-col" >
                                <Button sx={{ textTransform: 'none', display: 'flex' }} variant="outlined" onClick={exportDataJson}>
                                    <CardContent sx={{ textAlign: 'left' }}>
                                        <Typography gutterBottom>
                                            Latest Data <span className='text-[9px]'>(JSON)</span>
                                        </Typography>
